...
class HygrothermographCgdk2Accessory {
  ...
  get temperatureStatus() {
    ...
    } else if (this.batteryLevel > this.temperatureThreshold) {
      temperatureStatus = Characteristic.StatusHightTemperature.TEMPERATURE_HIGHT;
    } else {
      temperatureStatus = Characteristic.StatusHightTemperature.TEMPERATURE_NORMAL;
    }
  ...
  getTemperatureService() {
    ...
    temperatureService
      .getCharacteristic(Characteristic.StatusHightTemperature)
