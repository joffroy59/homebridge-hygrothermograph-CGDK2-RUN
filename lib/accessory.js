...
class HygrothermographCgdk2Accessory {
  ...
  setTemperatureStatus() {
    ...
    if (this.temperature == null) {
      ...
      temperatureStatus = Characteristic.StatusTampered.TAMPERED;
    } else {
      temperatureStatus = Characteristic.StatusTampered.NOT_TAMPERED;
    }
    this.log.warn("temperature Status: ${temperatureStatus}");
