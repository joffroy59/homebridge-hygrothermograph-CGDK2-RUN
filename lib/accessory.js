...
class HygrothermographCgdk2Accessory {
  ...
  setTemperatureStatus() {
    ...
    if (this.temperature == null) {
      ...
      this.temperatureStatus = Characteristic.StatusTampered.TAMPERED;
    } else {
      this.temperatureStatus = Characteristic.StatusTampered.NOT_TAMPERED;
    }
    this.log.warn("temperature Status: ${this.temperatureStatus}");
  ...
  alarm() {
    ...
    log.warn("###########")
    // TODO 
    log.warn("send alert notification");
  }
}
